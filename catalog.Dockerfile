...
ENV __doozer_release=20260813222736.ocp4.20
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.5.2.202608132150.p2.g75664fd.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.5.2-20260813222736.ocp4.20
