...
ENV __doozer_release=20260203015544
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.12.0.202602030110.p2.gebf64c5.assembly.stream.el8-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.12.0-20260203015544
