...
ENV __doozer_release=20260304093730
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.19.0.202603040916.p2.gd9815db.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.19.0-20260304093730
