...
ENV __doozer_release=20251113195940
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.4.7.202511131919.p2.g00a4e1e.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.4.7-20251113195940
