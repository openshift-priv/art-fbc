...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.23.0.202608041740.p2.gb19eda0.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ingress-node-firewall
LABEL io.openshift.build.commit.id=b19eda0eb91a5f5aae41849f21137e095b08960e
LABEL com.redhat.art.name=ingress-node-firewall-operator-fbc
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.23.0-20260804230029
