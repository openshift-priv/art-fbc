...
ENV __doozer_release=20260926004419
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.16.0.202609251751.p2.g808cdce.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-nfd-operator
LABEL io.openshift.build.commit.id=808cdce85b4c01c85e0332b8b0b41f73ceaebba0
LABEL com.redhat.art.name=cluster-nfd-operator-fbc
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.16.0-20260926004419
