...
ENV __doozer_release=20260528142745
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.13.0.202605271326.p2.g1284973.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.13.0-20260528142745
