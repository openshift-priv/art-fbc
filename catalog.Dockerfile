...
ENV __doozer_release=20260923193007.ocp4.15
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.0.17.202609231752.p2.gc5e05e1.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=c5e05e1bc0929d485eaf5a4b4e5ad454aff42a34
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.0.17-20260923193007.ocp4.15
