...
ENV __doozer_release=20260320195515
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.3.5.202603201929.p2.gdcff923.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=dcff923f2116d47036ece9f8be4c20c1baccb0e2
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.3.5-20260320195515
