...
ENV __doozer_release=20260203152629
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.3.3.202602030122.p2.gc39251c.assembly.stream.el9-2
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.3.3-20260203152629
