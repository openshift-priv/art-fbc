...
ENV __doozer_release=20260701210150
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v5.0.0.202607011929.p2.gf1e4ccd.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-5.0.0-20260701210150
