...
ENV __doozer_release=20260605073007
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.20.0.202606050619.p2.g811709b.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/sriov-network-operator
LABEL io.openshift.build.commit.id=811709b229df716efe5441738de3b658e361c482
LABEL com.redhat.art.name=sriov-network-operator-fbc
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.20.0-20260605073007
