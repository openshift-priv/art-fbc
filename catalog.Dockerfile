...
ENV __doozer_release=20260304135222
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.12.0.202603041308.p2.g688448a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.12.0-20260304135222
