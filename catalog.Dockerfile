...
ENV __doozer_release=20260210024117
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.1.0.202602100135.p2.ga1f4b61.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mta-operator
LABEL io.openshift.build.commit.id=a1f4b6128f23a8faf01a68ac7b6aa1b020294700
LABEL com.redhat.art.name=mta-operator-fbc
LABEL com.redhat.art.nvr=mta-operator-fbc-8.1.0-20260210024117
