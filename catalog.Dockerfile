...
ENV __doozer_release=20260630092838
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.22.0.202606300622.p2.gd6b5ccc.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.22.0-20260630092838
