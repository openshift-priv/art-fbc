...
ENV __doozer_release=20260323180220
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.3.5.202603231728.p2.gee88611.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.3.5-20260323180220
