...
ENV __doozer_release=20260827153332
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v5.0.0.202608271409.p2.g7d7aae1.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-5.0.0-20260827153332
