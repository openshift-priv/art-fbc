...
ENV __doozer_release=20260422224120.ocp4.16
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.2.10.202604222134.p2.gbf4e652.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=bf4e6522923458060f79e859fa8bb25b60bdf5bb
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.2.10-20260422224120.ocp4.16
