...
ENV __doozer_version=6.3.0
ENV __doozer_release=20251113131141
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.3.0.202511131153.p2.g9661177.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=966117751c4845ffda26c7f43b0a2248e07f5ea4
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.3.0-20251113131141
