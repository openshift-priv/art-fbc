...
ENV __doozer_release=20251008151850
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.5.3.202510072012.p2.gc1f59eb.assembly.stream.el9-2
...
LABEL com.redhat.art.nvr=oadp-operator-fbc-4.15.0-20251008151850
