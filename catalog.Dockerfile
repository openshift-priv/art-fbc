...
ENV __doozer_release=20260125024923
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.16.0.202601250115.p2.gdcc94c2.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.16.0-20260125024923
