...
ENV __doozer_release=20260310150600
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.14.0.202603101414.p2.gb57dcdb.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.14.0-20260310150600
