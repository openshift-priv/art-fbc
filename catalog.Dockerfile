...
ENV __doozer_release=20251116102943
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.21.0.202511160949.p2.g985c9e2.assembly.minimal.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/must-gather-operator
LABEL io.openshift.build.commit.id=985c9e2c687988f934b0c1435e282d76490b6df1
LABEL com.redhat.art.name=ose-support-log-gather-operator-fbc
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.21.0-20251116102943
