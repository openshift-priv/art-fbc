...
ENV __doozer_release=20260606161820
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v5.0.0.202606061245.p2.g931e5bf.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-5.0.0-20260606161820
