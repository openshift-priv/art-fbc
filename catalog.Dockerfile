...
ENV __doozer_version=6.6.1
ENV __doozer_release=20260722043828.ocp4.20
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.6.1.202607220327.p2.g678d2ac.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=678d2ac8088db408522b9166691e75215fe8bec2
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.6.1-20260722043828.ocp4.20
