...
ENV __doozer_release=20260124053351
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.21.0.202601240019.p2.g9cac901.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.21.0-20260124053351
