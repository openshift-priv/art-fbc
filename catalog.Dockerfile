...
ENV __doozer_release=20260412223910
ENV __doozer_bundle_nvrs=ose-secrets-store-csi-driver-operator-bundle-container-v4.20.0.202604121952.p2.g354833a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-secrets-store-csi-driver-operator-fbc-4.20.0-20260412223910
