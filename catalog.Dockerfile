...
ENV __doozer_release=20260902135254
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.18.0.202609021227.p2.g1284973.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.18.0-20260902135254
