...
ENV __doozer_release=20251201121936
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.21.0.202512011022.p2.g1b73c64.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/local-storage-operator
LABEL io.openshift.build.commit.id=1b73c64d9dabc6fa80fdb227d38b7c678a8b3cb0
LABEL com.redhat.art.name=local-storage-operator-fbc
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.21.0-20251201121936
