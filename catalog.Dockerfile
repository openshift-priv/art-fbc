...
ENV __doozer_release=20260227233139
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.18.0.202602272244.p2.g688448a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.18.0-20260227233139
