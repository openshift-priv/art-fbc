...
ENV __doozer_release=20251002075202
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.20.0.202510020654.p2.g9a51ea2.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.20.0-20251002075202
