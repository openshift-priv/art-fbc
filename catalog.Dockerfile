...
ENV __doozer_release=20250926080805
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-container-v4.21.0.202509260624.p2.gcfd08f7.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-4.21.0-20250926080805
