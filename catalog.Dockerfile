...
ENV __doozer_release=20251206145316
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.3.2.202512061429.p2.g268cb35.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=268cb35fbd87c13a772ee46be26bdbad718290ab
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.3.2-20251206145316
