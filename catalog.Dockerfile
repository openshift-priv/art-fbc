...
ENV __doozer_release=20251110184405
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.21.0.202511101523.p2.g896a128.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.21.0-20251110184405
