...
ENV __doozer_release=20260120120554
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-container-v4.22.0.202601200755.p2.ge08ab06.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-4.22.0-20260120120554
