...
ENV __doozer_release=20260923205127
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.15.0.202609231127.p2.gca40ba9.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.15.0-20260923205127
