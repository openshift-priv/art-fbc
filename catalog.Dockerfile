...
ENV __doozer_release=20260831071833.ocp4.14
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.0.17.202608310435.p2.g06e6fee.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=06e6fee0d22f0fbe2d8a0719f22b1fccb01e65f0
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.0.17-20260831071833.ocp4.14
