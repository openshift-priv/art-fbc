...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.20.0.202607162226.p2.g418bb5b.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ingress-node-firewall
LABEL io.openshift.build.commit.id=418bb5be089ed446315dd195487d6179c408f8b4
LABEL com.redhat.art.name=ingress-node-firewall-operator-fbc
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.20.0-20260716232814
