...
ENV __doozer_release=20250922024523
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.18.0.202509220121.p2.gfe4f407.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.18.0-20250922024523
