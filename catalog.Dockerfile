...
ENV __doozer_release=20260518130740
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.12.0.202605181205.p2.g269ccd3.assembly.stream.el8-1
LABEL io.openshift.build.source-location=https://github.com/openshift/sriov-network-operator
LABEL io.openshift.build.commit.id=269ccd3ca8fea314fa80b924d728a3467c5ae1fb
LABEL com.redhat.art.name=sriov-network-operator-fbc
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.12.0-20260518130740
