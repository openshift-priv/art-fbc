...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.21.0.202601121715.p2.g96727eb.assembly.stream.el9-3
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.21.0-20260113074354
