...
ENV __doozer_version=1.4.8
ENV __doozer_release=20260207001652
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.4.8.202602062322.p2.gd7cfcf5.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=d7cfcf5ecd426b207ff9ee5cddd210f9acfb4d42
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.4.8-20260207001652
