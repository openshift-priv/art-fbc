...
ENV __doozer_release=20260402183019
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.5.1.202604021800.p2.g28a725b.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=28a725b1578d5c5971884b17a14be143b0032b9d
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.5.1-20260402183019
