...
ENV __doozer_release=20260513024758
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.22.0.202605130116.p2.g3414aa9.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.22.0-20260513024758
