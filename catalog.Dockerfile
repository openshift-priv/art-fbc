...
ENV __doozer_release=20251004143840
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.14.0.202510041324.p2.gb7f2132.assembly.stream.el8-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.14.0-20251004143840
