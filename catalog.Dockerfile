...
ENV __doozer_release=20251121184937
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.17.0.202511211445.p2.gc17cda3.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.17.0-20251121184937
