...
ENV __doozer_release=20260805230119.ocp4.23
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.6.1.202608052233.p2.g81f6fb5.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=81f6fb533e367be554fe157c3536a7ed1c798d73
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.6.1-20260805230119.ocp4.23
