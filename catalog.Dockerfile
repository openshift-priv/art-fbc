...
ENV __doozer_release=20260921231006
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v5.1.0.202609212021.p2.gcddf3fb.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-5.1.0-20260921231006
