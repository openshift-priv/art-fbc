...
ENV __doozer_release=20260505154636
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.22.0.202605051417.p2.g199f528.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/sriov-network-operator
LABEL io.openshift.build.commit.id=199f528c47393bee25f7369c0d1e86c0557bd264
LABEL com.redhat.art.name=sriov-network-operator-fbc
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.22.0-20260505154636
