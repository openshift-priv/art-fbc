...
ENV __doozer_release=20260813234414.ocp4.16
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.4.11.202608132305.p2.gbc29ba5.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=bc29ba50b2f9f74a64012425691636e6550259fa
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.4.11-20260813234414.ocp4.16
