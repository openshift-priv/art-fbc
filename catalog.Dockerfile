...
ENV __doozer_release=20260826214137
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v5.0.0.202608261855.p2.g3f16267.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-5.0.0-20260826214137
