...
ENV __doozer_release=20260920011454.ocp4.19
ENV __doozer_bundle_nvrs=cert-manager-operator-metadata-container-1.19.0.202609200036.p2.g22755db.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cert-manager-operator-fbc-1.19.0-20260920011454.ocp4.19
