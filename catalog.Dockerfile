...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.16.0.202606081748.p2.gd214d48.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ingress-node-firewall
LABEL io.openshift.build.commit.id=d214d4886e893f3214942a99696659e95c21e845
LABEL com.redhat.art.name=ingress-node-firewall-operator-fbc
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.16.0-20260609051625
