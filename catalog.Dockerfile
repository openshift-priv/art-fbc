...
ENV __doozer_release=20260522024538
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.23.0.202605220128.p2.gb7fda9c.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.23.0-20260522024538
