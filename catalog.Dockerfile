...
ENV __doozer_release=20260716111810
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.20.0.202607161010.p2.g4c6950f.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.20.0-20260716111810
