...
ENV __doozer_release=20251210031401
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.0.99.202512100144.p2.g86a471e.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mta-operator
LABEL io.openshift.build.commit.id=86a471e6e2919f000045924ed557f67b951a711b
LABEL com.redhat.art.name=mta-operator-fbc
LABEL com.redhat.art.nvr=mta-operator-fbc-8.0.99-20251210031401
