...
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-container-v5.0.0.202604040550.p2.ged09db1.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-5.0.0-20260404101957
