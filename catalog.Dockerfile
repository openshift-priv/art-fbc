...
ENV __doozer_release=20260218145146
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.16.0.202602180410.p2.g24b33ec.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.16.0-20260218145146
