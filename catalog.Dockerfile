...
ENV __doozer_release=20260305093725
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.13.0.202603050917.p2.g688448a.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.13.0-20260305093725
