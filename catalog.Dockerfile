...
ENV __doozer_release=20260622045906
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v5.0.0.202606220255.p2.g9abc668.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-5.0.0-20260622045906
