...
ENV __doozer_version=6.5.3
ENV __doozer_release=20260831060214.ocp4.21
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.5.3.202608310432.p2.g645d000.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=645d0009492a0e2cbeb0d3ebdbf0e03ed49469e7
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.5.3-20260831060214.ocp4.21
