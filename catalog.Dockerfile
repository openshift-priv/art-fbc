...
ENV __doozer_release=20260210105135
ENV __doozer_bundle_nvrs=ose-ptp-operator-metadata-container-v4.22.0.202602101037.p2.gaa405df.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ptp-operator
LABEL io.openshift.build.commit.id=aa405df74c27547b03209be2177a70dbb4b15864
LABEL com.redhat.art.name=ptp-operator-fbc
LABEL com.redhat.art.nvr=ptp-operator-fbc-4.22.0-20260210105135
