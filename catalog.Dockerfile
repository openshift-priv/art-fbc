...
ENV __doozer_release=20260731103718
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.16.0.202607310947.p2.g73ffbb9.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.16.0-20260731103718
