...
ENV __doozer_release=20260318185319
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.16.0.202603181358.p2.g1536f9e.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.16.0-20260318185319
