...
ENV __doozer_release=20260305021921
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.16.0.202603050115.p2.g688448a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.16.0-20260305021921
