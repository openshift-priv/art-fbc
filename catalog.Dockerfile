...
ENV __doozer_release=20260604053256.ocp4.14
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.0.15.202606040414.p2.gac33a53.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.0.15-20260604053256.ocp4.14
