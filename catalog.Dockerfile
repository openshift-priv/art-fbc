...
ENV __doozer_release=20250417083717
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-v4.18.0.202503210113.p0.gc20e0b7.assembly.stream.el9-3
...
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-4.18.0-20250417083717
