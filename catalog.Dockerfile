...
ENV __doozer_release=20260801134639
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.15.0.202608011050.p2.g8533055.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.15.0-20260801134639
