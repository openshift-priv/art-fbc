...
ENV __doozer_release=20251114174120
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.21.0.202511141727.p2.g397dcaa.assembly.minimal.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/local-storage-operator
LABEL io.openshift.build.commit.id=397dcaa02032f52916aa3ed49e5b9ecd1b96cc01
LABEL com.redhat.art.name=local-storage-operator-fbc
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.21.0-20251114174120
