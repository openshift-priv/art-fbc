...
ENV __doozer_release=20250930093619
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.19.0.202509300824.p2.gd9815db.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.19.0-20250930093619
