...
ENV __doozer_release=20260225164719
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.16.0.202602251600.p2.ga942fe1.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=a942fe14ed7bf4f4d63126523d567093b66c8cb8
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.16.0-20260225164719
