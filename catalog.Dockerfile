...
ENV __doozer_release=20250819024603
ENV __doozer_bundle_nvrs=ose-ptp-operator-metadata-container-v4.16.0.202508190131.p2.g0b912e8.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ptp-operator
LABEL io.openshift.build.commit.id=0b912e8e3d744a85ca9796405473db4b8d2e8636
LABEL com.redhat.art.name=ptp-operator-fbc
LABEL com.redhat.art.nvr=ptp-operator-fbc-4.16.0-20250819024603
