...
ENV __doozer_release=20260905025003.ocp5.0
ENV __doozer_bundle_nvrs=mce-backplane-operator-metadata-container-5.0.0.202609050200.p2.ga5b2fd0.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/backplane-operator
LABEL io.openshift.build.commit.id=a5b2fd0929d7d38dcaa7ff4dbceb40e5c5b70de7
LABEL com.redhat.art.name=backplane-operator-fbc
LABEL com.redhat.art.nvr=backplane-operator-fbc-5.0.0-20260905025003.ocp5.0
