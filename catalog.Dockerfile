...
ENV __doozer_release=20260926101403
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.20.0.202609260346.p2.g86c9fd3.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.20.0-20260926101403
