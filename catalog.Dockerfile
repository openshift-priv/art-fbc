...
ENV __doozer_release=20260914032837.ocp4.21
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.7.0.202609140201.p2.gdde56c0.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.7.0-20260914032837.ocp4.21
