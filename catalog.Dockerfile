...
ENV __doozer_bundle_nvrs=ose-smb-csi-driver-operator-bundle-container-v4.16.0.202603041550.p2.gbfdf0d8.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/csi-operator
LABEL io.openshift.build.commit.id=bfdf0d80cadbcb9ead8c74ffb95dd6b4d22e6cb3
LABEL com.redhat.art.name=ose-smb-csi-driver-operator-fbc
LABEL com.redhat.art.nvr=ose-smb-csi-driver-operator-fbc-4.16.0-20260304163734
