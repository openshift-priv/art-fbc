...
ENV __doozer_version=1.8.12
ENV __doozer_release=20260123212026
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.12.202601232054.p2.g1fc87db.assembly.stream.el8-2
LABEL io.openshift.build.source-location=https://github.com/migtools/mig-operator
LABEL io.openshift.build.commit.id=1fc87db682fad7ad4a944c9d373ff25efccb6c74
LABEL com.redhat.art.name=openshift-migration-operator-fbc
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.12-20260123212026
