...
ENV __doozer_release=20260915201530.ocp5.0
ENV __doozer_bundle_nvrs=mce-backplane-operator-metadata-container-5.0.0.202609151840.p2.gc551035.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/backplane-operator
LABEL io.openshift.build.commit.id=c5510352e72aa582d4146f9f1ff81a0715baa4b0
LABEL com.redhat.art.name=backplane-operator-fbc
LABEL com.redhat.art.nvr=backplane-operator-fbc-5.0.0-20260915201530.ocp5.0
