...
ENV __doozer_release=20260224210311
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.12.0.202602242051.p2.gb189781.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/local-storage-operator
LABEL io.openshift.build.commit.id=b189781e2093004cbe07d371afe96e2ca83e568f
LABEL com.redhat.art.name=local-storage-operator-fbc
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.12.0-20260224210311
