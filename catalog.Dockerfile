...
ENV __doozer_release=20260226193838
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.3.4.202602261825.p2.gc82ddc9.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.3.4-20260226193838
