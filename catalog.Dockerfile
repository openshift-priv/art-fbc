...
ENV __doozer_release=20260910095743.ocp5.1
ENV __doozer_bundle_nvrs=acm-multiclusterhub-operator-metadata-container-5.0.0.202609100859.p2.g5dcb5f8.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/multiclusterhub-operator
LABEL io.openshift.build.commit.id=5dcb5f8d91eb77b268c51483b4107123e0287ea6
LABEL com.redhat.art.name=multiclusterhub-operator-fbc
LABEL com.redhat.art.nvr=multiclusterhub-operator-fbc-5.0.0-20260910095743.ocp5.1
