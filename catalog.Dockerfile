...
ENV __doozer_release=20260903033825.ocp4.22
ENV __doozer_bundle_nvrs=acm-multiclusterhub-operator-metadata-container-2.16.4.202609030241.p2.g7a9fe22.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/multiclusterhub-operator
LABEL io.openshift.build.commit.id=7a9fe2289d2d61a5cacc9bf11874902d14fd1196
LABEL com.redhat.art.name=multiclusterhub-operator-fbc
LABEL com.redhat.art.nvr=multiclusterhub-operator-fbc-2.16.4-20260903033825.ocp4.22
