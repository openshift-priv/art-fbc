...
ENV __doozer_release=20260910192955
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.20.0.202609101642.p2.g4c6950f.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.20.0-20260910192955
