...
ENV __doozer_release=20260203215051
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.1.0.202602032042.p2.gee820d2.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mta-operator
LABEL io.openshift.build.commit.id=ee820d2f286b4e6974c616af78c44f996321822e
LABEL com.redhat.art.name=mta-operator-fbc
LABEL com.redhat.art.nvr=mta-operator-fbc-8.1.0-20260203215051
