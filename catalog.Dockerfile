...
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-container-v4.20.0.202508130901.p2.g4041fe4.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/pf-status-relay-operator
LABEL io.openshift.build.commit.id=4041fe49b74eba1c3b9a3c1d518b4596accd7e53
LABEL com.redhat.art.name=pf-status-relay-operator-fbc
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-4.20.0-20250826140721
