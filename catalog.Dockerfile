...
ENV __doozer_release=20260119065946
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.18.0.202601190613.p2.gcacc16c.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.18.0-20260119065946
