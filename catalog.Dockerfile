...
ENV __doozer_release=20260804165605
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v5.0.0.202608041505.p2.gb19eda0.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-5.0.0-20260804165605
