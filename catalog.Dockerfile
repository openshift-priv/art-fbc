...
ENV __doozer_release=20251005130500
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.17.0.202510051149.p2.g9cc2f11.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=9cc2f11e55d789a08d5a8532fb25810884e9c8be
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.17.0-20251005130500
