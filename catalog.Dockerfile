...
ENV __doozer_release=20260609003509
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.23.0.202606081716.p2.gab62084.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/sriov-network-operator
LABEL io.openshift.build.commit.id=ab62084901227363cd62ebaecafc61967cda751a
LABEL com.redhat.art.name=sriov-network-operator-fbc
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.23.0-20260609003509
