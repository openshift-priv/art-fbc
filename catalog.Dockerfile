...
ENV __doozer_release=20260904183419.ocp4.18
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.4.7.202609041528.p2.g9ba15ca.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=9ba15ca55e2361e3ecdb5e5e55c76d286e89eac9
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.4.7-20260904183419.ocp4.18
