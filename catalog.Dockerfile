...
ENV __doozer_release=20260129150630
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.5.4.202601291349.p2.g26be5d4.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=26be5d47f7375ca8f64c29b627010a83426dd98d
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.5.4-20260129150630
