...
ENV __doozer_release=20260827183921.ocp4.15
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.3.0.202608271803.p2.g319ef8e.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=mta-operator-fbc-8.3.0-20260827183921.ocp4.15
