...
ENV __doozer_release=20260515195631
ENV __doozer_bundle_nvrs=ose-vertical-pod-autoscaler-operator-metadata-container-v5.0.0.202605150842.p2.gcce93b7.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=vertical-pod-autoscaler-operator-fbc-5.0.0-20260515195631
