...
ENV __doozer_release=20260309033352
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.15.0.202603090214.p2.g688448a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.15.0-20260309033352
