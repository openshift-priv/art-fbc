...
ENV __doozer_release=20260722043248
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.22.0.202607212058.p2.gc918b0a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.22.0-20260722043248
