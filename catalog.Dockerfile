...
ENV __doozer_release=20251210202259
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.3.2.202512102007.p2.g58b22a2.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=58b22a29dac0a147c319feaf4feb692bd75f1dc5
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.3.2-20251210202259
