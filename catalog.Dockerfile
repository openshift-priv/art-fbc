...
ENV __doozer_release=20251008115120
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.21.0.202510081025.p2.g4438a1f.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.21.0-20251008115120
