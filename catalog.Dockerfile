...
ENV __doozer_release=20250917235935
ENV __doozer_bundle_nvrs=ose-secrets-store-csi-driver-operator-bundle-container-v4.21.0.202509172132.p2.g881d0e2.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-secrets-store-csi-driver-operator-fbc-4.21.0-20250917235935
