...
ENV __doozer_release=20251014063151
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.17.0.202510140549.p2.g9ac0b2f.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.17.0-20251014063151
