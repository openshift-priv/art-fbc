...
ENV __doozer_release=20250528093450
ENV __doozer_bundle_nvrs=helloworld-operator-bundle-container-v4.18.0.202505200937.p3.g98132ba.assembly.test.el9-2
LABEL io.openshift.build.source-location=https://github.com/openshift-eng/ocp-build-data
LABEL io.openshift.build.commit.id=98132ba2f3a31123b137c7c5575662a67add9238
LABEL com.redhat.art.nvr=helloworld-operator-fbc-4.18.0-20250528093450
