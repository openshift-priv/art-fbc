...
ENV __doozer_release=20260826212139
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.20.0.202608262003.p2.g86c9fd3.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.20.0-20260826212139
