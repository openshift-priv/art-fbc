...
ENV __doozer_release=20260515041943
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.22.0.202605150323.p2.g0799028.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.22.0-20260515041943
