...
ENV __doozer_bundle_nvrs=ose-gcp-filestore-csi-driver-operator-bundle-container-v5.0.0.202607291647.p2.gc42d8e1.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-gcp-filestore-csi-driver-operator-fbc-5.0.0-20260729190652
