...
ENV __doozer_release=20260718122721
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.16.0.202607181016.p2.g1536f9e.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.16.0-20260718122721
