...
ENV __doozer_release=20260901143551.ocp4.22
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.7.0.202609011407.p2.g77b048b.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-logging-operator
LABEL io.openshift.build.commit.id=77b048bc0c71481631cbdfa15ba4027b0dea42f0
LABEL com.redhat.art.name=cluster-logging-operator-fbc
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.7.0-20260901143551.ocp4.22
