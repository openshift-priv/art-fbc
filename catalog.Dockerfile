...
ENV __doozer_release=20251112191745
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.11.202511121837.p2.g5c7f2e7.assembly.test.el8-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mig-operator
LABEL io.openshift.build.commit.id=5c7f2e7174000f6dd7f5a130eb0b4b776c561fb8
LABEL com.redhat.art.name=openshift-migration-operator-fbc
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.11-20251112191745
