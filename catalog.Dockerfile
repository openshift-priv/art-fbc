...
ENV __doozer_release=20260814020952.ocp4.20
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.5.8.202608140137.p2.gb6e2a35.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=b6e2a35fedb1203c5de5be53721a45f072028741
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.5.8-20260814020952.ocp4.20
