...
ENV __doozer_release=20260224101826
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.22.0.202602240938.p2.gd8a2b0e.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.22.0-20260224101826
