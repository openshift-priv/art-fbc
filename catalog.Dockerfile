...
ENV __doozer_version=1.5.8
ENV __doozer_release=20260702212103.ocp4.20
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.5.8.202607022058.p2.g181c14d.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=181c14d72fe99c57c89f1c25a6842129e4caab29
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.5.8-20260702212103.ocp4.20
