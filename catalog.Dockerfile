...
ENV __doozer_release=20260620094458
ENV __doozer_bundle_nvrs=ose-vertical-pod-autoscaler-operator-metadata-container-v5.0.0.202606200832.p2.gda534fb.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=vertical-pod-autoscaler-operator-fbc-5.0.0-20260620094458
