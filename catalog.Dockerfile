...
ENV __doozer_release=20260304013940
ENV __doozer_bundle_nvrs=ose-ptp-operator-metadata-container-v4.12.0.202603040109.p2.geffc30e.assembly.stream.el8-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ptp-operator
LABEL io.openshift.build.commit.id=effc30e64deafbedb399bb3ca892bf539a951e95
LABEL com.redhat.art.name=ptp-operator-fbc
LABEL com.redhat.art.nvr=ptp-operator-fbc-4.12.0-20260304013940
