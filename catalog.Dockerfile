...
ENV __doozer_release=20260916044101.ocp5.0
ENV __doozer_bundle_nvrs=mce-backplane-operator-metadata-container-5.0.0.202609160332.p2.g063e94a.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/backplane-operator
LABEL io.openshift.build.commit.id=063e94a9450025163f023e828790277bc4bede9f
LABEL com.redhat.art.name=backplane-operator-fbc
LABEL com.redhat.art.nvr=backplane-operator-fbc-5.0.0-20260916044101.ocp5.0
