...
ENV __doozer_release=20260210063144
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.21.0.202602100147.p2.gd463337.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.21.0-20260210063144
