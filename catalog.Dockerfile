...
ENV __doozer_release=20260818111118.ocp4.20
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.5.2.202608181003.p2.g75664fd.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.5.2-20260818111118.ocp4.20
