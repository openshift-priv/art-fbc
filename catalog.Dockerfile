...
ENV __doozer_release=20260520055143
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.13.0.202605200417.p2.gfe7e95e.assembly.stream.el8-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.13.0-20260520055143
