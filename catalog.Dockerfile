...
ENV __doozer_release=20260922081215
ENV __doozer_bundle_nvrs=ose-aws-efs-csi-driver-operator-bundle-container-v5.1.0.202609220336.p2.g773340c.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/csi-operator
LABEL io.openshift.build.commit.id=773340ccc6a7dc3657fe222c7ebd2fcc19adcd56
LABEL com.redhat.art.name=ose-aws-efs-csi-driver-operator-fbc
LABEL com.redhat.art.nvr=ose-aws-efs-csi-driver-operator-fbc-5.1.0-20260922081215
