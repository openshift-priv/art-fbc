...
ENV __doozer_release=20260616121658.ocp4.23
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.6.0.202606161158.p2.g3be0188.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=3be0188858fd1213653da2605282db169dc7c2a9
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.6.0-20260616121658.ocp4.23
