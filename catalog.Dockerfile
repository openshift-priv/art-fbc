...
ENV __doozer_release=20260824142017
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.20.0.202608241218.p2.g745de3b.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-nfd-operator
LABEL io.openshift.build.commit.id=745de3b7004ef5e07f1bc4a2646bff7779cf39b0
LABEL com.redhat.art.name=cluster-nfd-operator-fbc
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.20.0-20260824142017
