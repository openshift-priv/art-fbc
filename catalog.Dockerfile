...
ENV __doozer_release=20260604160814.ocp4.19
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.15.202606041546.p2.gb768cea.assembly.test.el8-1
...
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.15-20260604160814.ocp4.19
