...
ENV __doozer_release=20250910204054
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-v1.0.0.202509102019.p2.gae03c8d.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=ae03c8d649765f565c01b3e92ffe5c90aaabda42
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-4.20.0-20250910204054
