...
ENV __doozer_release=20260906014810.ocp4.19
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.5.8.202609060128.p2.g53bd53d.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=53bd53d30bb6ffa100db297c8598729c74bda3ca
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.5.8-20260906014810.ocp4.19
