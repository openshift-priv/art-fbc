...
ENV __doozer_release=20260915184606.ocp5.0
ENV __doozer_bundle_nvrs=mce-backplane-operator-metadata-container-5.0.0.202609151607.p2.gc551035.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=backplane-operator-fbc-5.0.0-20260915184606.ocp5.0
