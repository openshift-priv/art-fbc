...
ENV __doozer_release=20260117215723
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.22.0.202601172038.p2.gc930ea4.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/local-storage-operator
LABEL io.openshift.build.commit.id=c930ea412cde390f45acaa9643da69f12fbeb57e
LABEL com.redhat.art.name=local-storage-operator-fbc
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.22.0-20260117215723
