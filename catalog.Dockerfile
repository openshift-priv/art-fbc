...
ENV __doozer_release=20250918181419
ENV __doozer_bundle_nvrs=ose-secrets-store-csi-driver-operator-bundle-container-v4.21.0.202509181533.p2.gcbafac2.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-secrets-store-csi-driver-operator-fbc-4.21.0-20250918181419
