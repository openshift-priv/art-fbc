...
ENV __doozer_release=20260416161952.ocp4.20
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.2.10.202604161455.p2.gbf4e652.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.2.10-20260416161952.ocp4.20
