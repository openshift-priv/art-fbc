...
ENV __doozer_release=20260723232154
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v5.0.0.202607232040.p2.g92569de.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-5.0.0-20260723232154
