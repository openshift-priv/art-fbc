...
ENV __doozer_release=20260519115046
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v5.0.0.202605191017.p2.g2394cf2.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-5.0.0-20260519115046
