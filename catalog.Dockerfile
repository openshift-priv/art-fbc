...
ENV __doozer_release=20260227215743
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.17.0.202602272136.p2.g688448a.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.17.0-20260227215743
