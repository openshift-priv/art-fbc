...
ENV __doozer_release=20260827083804.ocp4.15
ENV __doozer_bundle_nvrs=container-security-operator-metadata-container-3.17.5.202608270752.p2.gc8e8f33.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/quay/container-security-operator
LABEL io.openshift.build.commit.id=c8e8f33ccb9c5f848eaacac04ce0d9341d6fc1b7
LABEL com.redhat.art.name=container-security-operator-fbc
LABEL com.redhat.art.nvr=container-security-operator-fbc-3.17.5-20260827083804.ocp4.15
