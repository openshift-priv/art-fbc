...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.21.0.202509262039.p2.g56cd5f3.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ingress-node-firewall
LABEL io.openshift.build.commit.id=56cd5f323a0b4c9f6d18987fff3c2904b3096eda
LABEL com.redhat.art.name=ingress-node-firewall-operator-fbc
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.21.0-20250930185019
