...
ENV __doozer_release=20260216200031
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.17.0.202602090843.p2.gc17cda3.assembly.stream.el9-4
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.17.0-20260216200031
