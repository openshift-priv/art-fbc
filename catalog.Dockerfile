...
ENV __doozer_release=20260206231428
ENV __doozer_bundle_nvrs=ose-ptp-operator-metadata-container-v4.21.0.202602062255.p2.g0dee6a0.assembly.coverage.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ptp-operator
LABEL io.openshift.build.commit.id=0dee6a03855ca2302dae8494d46fe50517b20e6d
LABEL com.redhat.art.name=ptp-operator-fbc
LABEL com.redhat.art.nvr=ptp-operator-fbc-4.21.0-20260206231428
