...
ENV __doozer_version=8.2.3
ENV __doozer_release=20260925122946.ocp4.18
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.2.3.202609251022.p2.g83e41e6.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mta-operator
LABEL io.openshift.build.commit.id=83e41e6049fe79e0e7a255801363866e7fbb5313
LABEL com.redhat.art.name=mta-operator-fbc
LABEL com.redhat.art.nvr=mta-operator-fbc-8.2.3-20260925122946.ocp4.18
