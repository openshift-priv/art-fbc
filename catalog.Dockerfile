...
ENV __doozer_bundle_nvrs=ose-aws-efs-csi-driver-operator-bundle-container-v5.1.0.202609021612.p2.g857bbb1.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/csi-operator
LABEL io.openshift.build.commit.id=857bbb16fa89b0b531e27ed0fc0eaa1e94efecb6
LABEL com.redhat.art.name=ose-aws-efs-csi-driver-operator-fbc
LABEL com.redhat.art.nvr=ose-aws-efs-csi-driver-operator-fbc-5.1.0-20260902201931
