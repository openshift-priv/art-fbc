...
ENV __doozer_release=20251016083229
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.18.0.202510160720.p2.gaf3dc60.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=af3dc6072a10d17aeeafc6e828cd2299dc4c374e
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.18.0-20251016083229
