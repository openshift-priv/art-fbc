...
ENV __doozer_release=20260411080737
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.18.0.202604110713.p2.g0fe75f4.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=0fe75f490a015b654027f988a17847f17e0812b7
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.18.0-20260411080737
