...
ENV __doozer_release=20260920041524.ocp4.18
ENV __doozer_bundle_nvrs=zero-trust-workload-identity-manager-metadata-container-1.1.0.202609200308.p2.gc25a77c.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=zero-trust-workload-identity-manager-fbc-1.1.0-20260920041524.ocp4.18
