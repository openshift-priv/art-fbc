...
ENV __doozer_release=20260910103312.ocp4.18
ENV __doozer_bundle_nvrs=acm-multiclusterhub-operator-metadata-container-2.16.4.202609100929.p2.g8ebffed.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/stolostron/multiclusterhub-operator
LABEL io.openshift.build.commit.id=8ebffed8028a0e31e5510dd74b0dd86b5dffd6bd
LABEL com.redhat.art.name=multiclusterhub-operator-fbc
LABEL com.redhat.art.nvr=multiclusterhub-operator-fbc-2.16.4-20260910103312.ocp4.18
