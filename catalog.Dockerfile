...
ENV __doozer_release=20260610022750.ocp4.20
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.15.202606100205.p2.gb768cea.assembly.test.el8-1
...
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.15-20260610022750.ocp4.20
