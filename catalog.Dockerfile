...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v5.1.0.202609252048.p2.g783e06e.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/ingress-node-firewall
LABEL io.openshift.build.commit.id=783e06e8f84e462718a6d3955a6db9d4a6e8f5a1
LABEL com.redhat.art.name=ingress-node-firewall-operator-fbc
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-5.1.0-20260926051316
