...
ENV __doozer_release=20260622225330
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v5.0.0.202606222015.p2.g9519ecd.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-5.0.0-20260622225330
