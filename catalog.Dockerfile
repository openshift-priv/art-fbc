...
ENV __doozer_version=1.3.9
ENV __doozer_release=20260116174232
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.3.9.202601161653.p2.g78fb1d0.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=78fb1d0efe30edbea656cf7942292370cb1c6432
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.3.9-20260116174232
