...
ENV __doozer_release=20250910094035
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v4.20.0.202509100922.p2.g7d54888.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/must-gather-operator
LABEL io.openshift.build.commit.id=7d54888c32c052ce306e4a6e3d84eeb806e98952
LABEL com.redhat.art.name=ose-support-log-gather-operator-fbc
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-4.20.0-20250910094035
