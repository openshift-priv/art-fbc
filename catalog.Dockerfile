...
ENV __doozer_release=20260102233125
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.19.0.202601022119.p2.g995c68a.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.19.0-20260102233125
