...
ENV __doozer_release=20250901151204
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.18.0.202509011351.p2.gbe97333.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=be9733302e81869a34cb22f374dcedcf58a9650a
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.18.0-20250901151204
