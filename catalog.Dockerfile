...
ENV __doozer_version=1.8.13
ENV __doozer_release=20260226160650
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.13.202602261551.p2.g9c5b1f4.assembly.stream.el8-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mig-operator
LABEL io.openshift.build.commit.id=9c5b1f40adb7200a4002e4fb2a6ad3527c3ad497
LABEL com.redhat.art.name=openshift-migration-operator-fbc
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.13-20260226160650
