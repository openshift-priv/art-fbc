...
ENV __doozer_release=20260310194037
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.16.0.202603101354.p2.gb57dcdb.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.16.0-20260310194037
