...
ENV __doozer_version=1.4.6
ENV __doozer_release=20251013220423
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.4.6.202510132139.p2.ga4f20fd.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=a4f20fd474834a69eebdcd2eeece58231e54dec2
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.4.6-20251013220423
