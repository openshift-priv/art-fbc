...
ENV __doozer_release='202509090215.p?'
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-v1.0.0.202509060234.p2.g1d0b40b.assembly.test.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=1d0b40b2ed49bae0dd34d3bf0d9c66505cf6d983
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr='oadp-operator-fbc-4.20.0-202509090215.p?'
