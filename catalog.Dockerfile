...
ENV __doozer_bundle_nvrs=ose-metallb-operator-bundle-container-v4.13.0.202510221307.p2.g55fb4e3.assembly.stream.el8-1
LABEL io.openshift.build.source-location=https://github.com/openshift/metallb-operator
LABEL io.openshift.build.commit.id=55fb4e310a3cf634d2044a349370173715c119a6
LABEL com.redhat.art.name=ose-metallb-operator-fbc
LABEL com.redhat.art.nvr=ose-metallb-operator-fbc-4.13.0-20251022161427
