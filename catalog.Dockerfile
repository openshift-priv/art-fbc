...
ENV __doozer_release=20260624081018.ocp4.15
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.4.10.202606240657.p2.gc10a22a.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=c10a22a15a3696fd83d607cda185bf6818e8d61f
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.4.10-20260624081018.ocp4.15
