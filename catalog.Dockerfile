...
ENV __doozer_bundle_nvrs=pf-status-relay-operator-bundle-container-v4.23.0.202607061733.p2.gef145ad.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/pf-status-relay-operator
LABEL io.openshift.build.commit.id=ef145ad75526d3239bcc0c1e4465a07e724dfc15
LABEL com.redhat.art.name=pf-status-relay-operator-fbc
LABEL com.redhat.art.nvr=pf-status-relay-operator-fbc-4.23.0-20260706191931
