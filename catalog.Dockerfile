...
ENV __doozer_release=20260517202739
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.15.0.202605171921.p2.g1284973.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.15.0-20260517202739
