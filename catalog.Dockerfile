...
ENV __doozer_release=20251016104039
ENV __doozer_bundle_nvrs=ose-kubernetes-nmstate-operator-bundle-container-v4.13.0.202510131530.p2.gfea81b8.assembly.stream.el8-1
LABEL io.openshift.build.source-location=https://github.com/openshift/kubernetes-nmstate
LABEL io.openshift.build.commit.id=fea81b886a69e2fff73dc4ca88d2bdd884aa075c
LABEL com.redhat.art.name=openshift-kubernetes-nmstate-operator-fbc
LABEL com.redhat.art.nvr=openshift-kubernetes-nmstate-operator-fbc-4.13.0-20251016104039
