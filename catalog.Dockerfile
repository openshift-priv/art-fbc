...
ENV __doozer_release=20260813134024
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.15.0.202608131015.p2.g4ab0c62.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.15.0-20260813134024
