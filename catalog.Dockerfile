...
ENV __doozer_release=20260915055659.ocp4.19
ENV __doozer_bundle_nvrs=zero-trust-workload-identity-manager-metadata-container-1.1.0.202609150507.p2.gc25a77c.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=zero-trust-workload-identity-manager-fbc-1.1.0-20260915055659.ocp4.19
