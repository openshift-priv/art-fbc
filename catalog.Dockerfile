...
ENV __doozer_release=20260317185325
ENV __doozer_bundle_nvrs=openshift-migration-operator-metadata-container-1.8.14.202603171831.p2.g4a366c3.assembly.stream.el8-1
...
LABEL com.redhat.art.nvr=openshift-migration-operator-fbc-1.8.14-20260317185325
