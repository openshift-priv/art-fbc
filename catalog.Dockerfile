...
ENV __doozer_release=20250925210924
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.20.0.202509251856.p2.gb1ab501.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.20.0-20250925210924
