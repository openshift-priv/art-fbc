...
ENV __doozer_release=20260224191454
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.12.0.202602241904.p2.g24b33ec.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.12.0-20260224191454
