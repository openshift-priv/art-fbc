...
ENV __doozer_release=20260828023612
ENV __doozer_bundle_nvrs=ose-support-log-gather-operator-bundle-container-v5.0.0.202608280118.p2.gb45d5ed.assembly.test.el9-1
...
LABEL com.redhat.art.nvr=ose-support-log-gather-operator-fbc-5.0.0-20260828023612
