...
ENV __doozer_release=20260909171410
ENV __doozer_bundle_nvrs=ose-clusterresourceoverride-operator-metadata-container-v4.19.0.202609091632.p2.gd2c49ee.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-resource-override-admission-operator
LABEL io.openshift.build.commit.id=d2c49eeb33b88a78f8c0a32ccfa77cbb14f8884f
LABEL com.redhat.art.name=clusterresourceoverride-operator-fbc
LABEL com.redhat.art.nvr=clusterresourceoverride-operator-fbc-4.19.0-20260909171410
