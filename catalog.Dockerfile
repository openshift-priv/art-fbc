...
ENV __doozer_release=20260603003408
ENV __doozer_bundle_nvrs=ose-secrets-store-csi-driver-operator-bundle-container-v4.18.0.202606022314.p2.g2aac830.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-secrets-store-csi-driver-operator-fbc-4.18.0-20260603003408
