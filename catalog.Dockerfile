...
ENV __doozer_bundle_nvrs=ingress-node-firewall-operator-bundle-container-v4.14.0.202604031343.p2.gff4135b.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ingress-node-firewall-operator-fbc-4.14.0-20260403212833
