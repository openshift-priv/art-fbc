...
ENV __doozer_release=20260602200403
ENV __doozer_bundle_nvrs=ose-secrets-store-csi-driver-operator-bundle-container-v4.18.0.202606021847.p2.g2aac830.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=ose-secrets-store-csi-driver-operator-fbc-4.18.0-20260602200403
