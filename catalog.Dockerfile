...
ENV __doozer_bundle_nvrs=loki-rhel9-operator-metadata-container-6.6.0.202606240830.p2.g89bf563.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/loki
LABEL io.openshift.build.commit.id=89bf5638c2ca56ab9a1687e375104539f36bda56
LABEL com.redhat.art.name=loki-operator-fbc
LABEL com.redhat.art.nvr=loki-operator-fbc-6.6.0-20260624101656.ocp4.22
