...
ENV __doozer_version=8.2.2
ENV __doozer_release=20260911205602.ocp4.16
ENV __doozer_bundle_nvrs=mta-operator-metadata-container-8.2.2.202609112028.p2.g948b587.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/migtools/mta-operator
LABEL io.openshift.build.commit.id=948b5879eb53b71a027dc42a989fa4902f95f6cd
LABEL com.redhat.art.name=mta-operator-fbc
LABEL com.redhat.art.nvr=mta-operator-fbc-8.2.2-20260911205602.ocp4.16
