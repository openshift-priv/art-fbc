...
ENV __doozer_release=20260304165707
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.19.0.202603041418.p2.gd9815db.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.19.0-20260304165707
