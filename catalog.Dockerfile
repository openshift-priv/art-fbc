...
ENV __doozer_release=20260409024121
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.15.0.202604081319.p2.g1f4c027.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.15.0-20260409024121
