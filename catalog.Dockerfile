...
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.14.0.202508070118.p2.g599ce82.assembly.stream.el8-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.14.0-20250807120120
