...
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.23.0.202606300122.p2.ge1c5606.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/sriov-network-operator
LABEL io.openshift.build.commit.id=e1c5606538dbd3b6997bac685f9ee994c07ced7d
LABEL com.redhat.art.name=sriov-network-operator-fbc
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.23.0-20260630072142
