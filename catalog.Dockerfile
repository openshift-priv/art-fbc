...
ENV __doozer_release=20260915202119.ocp4.20
ENV __doozer_bundle_nvrs=external-secrets-operator-metadata-container-1.1.0.202609151909.p2.g2e365a2.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/external-secrets-operator
LABEL io.openshift.build.commit.id=2e365a2d0b3734be7a8e39b0906b5681703ed4b1
LABEL com.redhat.art.name=external-secrets-operator-fbc
LABEL com.redhat.art.nvr=external-secrets-operator-fbc-1.1.0-20260915202119.ocp4.20
