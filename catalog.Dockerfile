...
ENV __doozer_release=20260711123633
ENV __doozer_bundle_nvrs=sriov-network-operator-metadata-container-v4.15.0.202607111038.p2.g8533055.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=sriov-network-operator-fbc-4.15.0-20260711123633
