...
ENV __doozer_bundle_nvrs=dpu-operator-bundle-container-v4.21.0.202509171629.p2.g84036e3.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/dpu-operator
LABEL io.openshift.build.commit.id=84036e3ba669ca574274c30575e77aa54aae6053
LABEL com.redhat.art.name=dpu-operator-fbc
LABEL com.redhat.art.nvr=dpu-operator-fbc-4.21.0-20250917181312
