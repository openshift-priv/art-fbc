...
ENV __doozer_release=20260924123359.ocp4.23
ENV __doozer_bundle_nvrs=ose-cluster-logging-operator-metadata-container-6.7.0.202609241147.p2.g903d6a6.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=cluster-logging-operator-fbc-6.7.0-20260924123359.ocp4.23
