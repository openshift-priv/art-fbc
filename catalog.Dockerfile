...
ENV __doozer_release=20260316020145
ENV __doozer_bundle_nvrs=local-storage-operator-metadata-container-v4.18.0.202603152157.p2.g1f4c027.assembly.stream.el9-1
...
LABEL com.redhat.art.nvr=local-storage-operator-fbc-4.18.0-20260316020145
