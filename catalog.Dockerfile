...
ENV __doozer_bundle_nvrs=cluster-nfd-operator-metadata-container-v4.23.0.202607311814.p2.g75d1c57.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/cluster-nfd-operator
LABEL io.openshift.build.commit.id=75d1c5729a5fa05835c617bc7aecbe8abb950a30
LABEL com.redhat.art.name=cluster-nfd-operator-fbc
LABEL com.redhat.art.nvr=cluster-nfd-operator-fbc-4.23.0-20260801024715
