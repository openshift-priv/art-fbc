...
ENV __doozer_release=20260327171703
ENV __doozer_bundle_nvrs=oadp-operator-metadata-container-1.6.0.202603271629.p2.gb74f410.assembly.stream.el9-1
LABEL io.openshift.build.source-location=https://github.com/openshift/oadp-operator
LABEL io.openshift.build.commit.id=b74f4102f18e13b38d099adf9c311f55fb577d1e
LABEL com.redhat.art.name=oadp-operator-fbc
LABEL com.redhat.art.nvr=oadp-operator-fbc-1.6.0-20260327171703
